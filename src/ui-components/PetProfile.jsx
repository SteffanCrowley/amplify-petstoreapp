...
export default function PetProfile(props) {
  ...
  const buttonThreeOneFiveZeroTwoSixEightNineOnClick = useDataStoreDeleteAction(
  ...
  return (
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeOneFiveZeroTwoSixEightNineOnClick();
        }}
        {...getOverrideProps(overrides, "Button31502689")}
      ></Button>
      <Image
        width="160px"
        height="160px"
