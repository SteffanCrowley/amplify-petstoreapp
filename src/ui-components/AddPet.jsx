...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeOneFiveTwoTwoSevenZeroEightValue,
    setTextFieldThreeOneFiveTwoTwoSevenZeroEightValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeOneFiveTwoTwoSevenTwoTwoValue,
    setTextFieldThreeOneFiveTwoTwoSevenTwoTwoValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeOneFiveTwoTwoSevenOneFiveValue,
    setTextFieldThreeOneFiveTwoTwoSevenOneFiveValue,
  ] = useStateMutationAction("");
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      about: textFieldThreeOneFiveTwoTwoSevenZeroEightValue,
      image: textFieldThreeOneFiveTwoTwoSevenTwoTwoValue,
      color: textFieldThreeOneFiveTwoTwoSevenOneFiveValue,
    },
    model: Pet,
    schema: schema,
  });
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveTwoTwoSevenZeroEightValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveTwoTwoSevenZeroEightValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31522708")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveTwoTwoSevenOneFiveValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveTwoTwoSevenOneFiveValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31522715")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveTwoTwoSevenTwoTwoValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveTwoTwoSevenTwoTwoValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31522722")}
          ></TextField>
        </Flex>
        <Divider
          height="1px"
        ...
        >
          ...
          <Button
            ...
            variation="primary"
            children="Update"
            {...getOverrideProps(overrides, "Button31522730")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
